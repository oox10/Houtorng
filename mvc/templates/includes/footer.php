...
<footer id="footer">
    <div class="container">
        ...
        <div id="footer-top">
            ...
            <div class="one-fourth">
                <div class="widget">
                    <h3>${Map}</h3>
                    <div class="tweet">
					  <a href='index.php?act=contact' target=_self><img src='images/mylocation.jpg'></a>
					</div>
                </div>
            </div>
        ...
        <div id="footer-bottom">
            <div class="one-half">
			<p>Copyright &copy; 2015 HouTorng. Created by <a target="_blank" href="http://www.doraho.link/">DoraHo</a>.</p>
            </div>
            ...
            <div class="one-half column-last">
                <nav id="footer-nav">
                    <ul>
                        ...
                        <li><a href="index.php?act=aboutus">${About Us}</a> &middot;</li>
                        <li><a href="index.php?act=product">${Products}</a> &middot;</li>
