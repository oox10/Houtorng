	    ...
	    <ul class='main_manual'>
		  <li>
		    ...
		    <ul class='group_manuel'>
			  <li  title='帳號管理'	 class='option func_activate'	id='Staff'	><i class="fa fa-user" aria-hidden="true"></i> <span >帳號管理</span> </li>
			</ul>
		  </li>
		  ...
		  <li>
		    ...
		    <ul class='group_manuel'>
			  <li  title='使用者回報' class='option' id='user_feedback'><i class="fa fa-bug" aria-hidden="true"></i> <span >錯誤回報</span> </li>
			</ul>
		  </li>
	    </ul>
	  </div>
